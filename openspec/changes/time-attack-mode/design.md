...
| ボス | 倍率 | 例 |
|------|------|-----|
| Lv1–3 鬼 | ×5 | Lv1: waveMax 100 → HP 500 |
| Lv4–7 鬼 | ×3 | Lv5: waveMax 2,750 → HP 8,250 |
| Lv8 鬼 | ×2 | Lv8: waveMax 2,750 → HP 5,500 |
| Lv9 閻魔 | ×2 | Lv9: waveMax 4,950 → HP 9,900 |
| Lv10 黒い閻魔 | ×4 | Lv10: waveMax 4,000 → HP 16,000 |
