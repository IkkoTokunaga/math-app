...
- 会員向けタイムアタック（Lv1 スタート → Lv8 鬼 → Lv9 紫閻魔 → Lv10 黒閻魔 → Lv11 黒閻魔＋時間の魔法 → クリア）
...
4. **HP ≤ 0（撃破）**:
   ...
   - Lv10 黒い閻魔撃破: Lv11 へ（同一 `/enma-lv10.png`）, HP リセット
   - Lv11 黒い閻魔撃破: **長め撃破エフェクト** → **「鬼、すべて撃破！」** → `cleared` → 結果画面
