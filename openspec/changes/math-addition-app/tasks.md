...
- [x] 8.1 10レベルの問題生成ロジックを実装する（繰り上がり判定・3項足し算含む）(lib/questions.ts)
- [x] 8.2 レベル解放を Lv2–Lv10 まで拡張する (lib/levels.ts)
- [x] 8.3 算式表示を3項対応・1行表示（改行なし）に更新する (PlayClient)
- [x] 8.4 回答入力を最大4桁（Lv10）に対応する
- [x] 8.5 question_logs に operand_c カラムを追加する（マイグレーション）
- [x] 8.6 結果画面・進捗画面の算式表示を3項対応に更新する
- [x] 8.7 レベル選択 UI を Lv1–Lv10 表示に更新する
